...
def build_model(input_shape):
    ...
    model = tf.keras.Sequential([
        Dense(256, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', \
              input_shape=input_shape, name='dense_one'),
        BatchNormalization(),  # <- Batch normalisation layer
        Dense(256, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_two'),
        BatchNormalization(),
        Dense(256, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_three'),
        BatchNormalization(),
