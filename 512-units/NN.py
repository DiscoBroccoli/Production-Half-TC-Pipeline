...
def build_model(input_shape):
    ...
    model = tf.keras.Sequential([
        Dense(512, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', \
              input_shape=input_shape, name='dense_one'),
        BatchNormalization(),  # <- Batch normalisation layer
        Dense(512, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_two'),
        BatchNormalization(),
        Dense(512, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_three'),
        BatchNormalization(),
