...
def build_model(input_shape):
    ...
    model = tf.keras.Sequential([
        Dense(128, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', \
              input_shape=input_shape, name='dense_one'),
        BatchNormalization(),  # <- Batch normalisation layer
        Dense(128, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_two'),
        BatchNormalization(),
        Dense(128, activation='relu', kernel_initializer='GlorotUniform', bias_initializer='zeros', name='dense_three'),
        BatchNormalization(),
...
def train_model(model, train_data, train_targets, epochs):
    ...
    """
    history = model.fit(train_data, train_targets, epochs=epochs, validation_split=0.2, batch_size=10, verbose=2)

    return history

#%%

history = train_model(model, x_train_standard, y_train_shuffled, epochs=30)
